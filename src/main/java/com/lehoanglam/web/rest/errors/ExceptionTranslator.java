...
import com.yes4all.service.dto.ErrorResponseDTO;
import com.yes4all.web.rest.config.CustomRestExceptionHandler;
import java.net.URI;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> process(@Nullable ResponseEntity<Problem> entity, NativeWebRequest request) {
        log.info("---ExceptionTranslator -- process");
        if (entity == null) {
            return null;
        }
    ...
    protected ResponseEntity<ErrorResponseDTO> handleValidationException(BusinessLogicException exception, WebRequest request) {
        ErrorResponseDTO error = new ErrorResponseDTO(
            "Not Match Business exceptions",
    ...
    public ProblemBuilder prepare(final Throwable throwable, final StatusType status, final URI type) {
        log.info("---ExceptionTranslator -- prepare");
        ...
        if (
            ...
            log.info("---ExceptionTranslator -- In Prepare");
