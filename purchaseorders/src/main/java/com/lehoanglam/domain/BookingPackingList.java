...
public class BookingPackingList implements Serializable {
    ...
    private BookingProformaInvoice bookingProformaInvoice ;
    ...
    public BookingProformaInvoice getBookingProformaInvoice() {
        return bookingProformaInvoice;
    }

    public void setBookingProformaInvoice(BookingProformaInvoice bookingProformaInvoice) {
